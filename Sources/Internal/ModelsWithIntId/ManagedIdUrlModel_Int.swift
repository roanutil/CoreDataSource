...
package struct ManagedIdUrlModel_IntId: Hashable, Sendable {
    package let id: Int
...
extension ManagedIdUrlModel_IntId: ManagedIdUrlReferencable {}

extension ManagedIdUrlModel_IntId: FetchableUnmanagedModel {
...
extension ManagedIdUrlModel_IntId: ReadableUnmanagedModel {}

extension ManagedIdUrlModel_IntId: WritableUnmanagedModel {
    @inlinable
...
extension ManagedIdUrlModel_IntId: Comparable {
