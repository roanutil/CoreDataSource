...
package struct IdentifiableModel_UuidId: Hashable, Sendable {
...
extension IdentifiableModel_UuidId: IdentifiedUnmanagedModel {
    @inlinable
...
extension IdentifiableModel_UuidId: Comparable {
